...
class Access
{
  public:
    struct Cols
    {
        ...
        static const std::string _devices_id;
     ...
     */
    explicit Access(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Access(const Json::Value &pJson) noexcept(false);
     ...
     */
    Access(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column devices_id  */
    ///Get the value of the column devices_id, returns the default value if the column is null
    const int32_t &getValueOfDevicesId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getDevicesId() const noexcept;
    ///Set the value of the column devices_id
    void setDevicesId(const int32_t &pDevicesId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Access>;
    friend drogon::orm::BaseBuilder<Access, true, true>;
    friend drogon::orm::BaseBuilder<Access, true, false>;
    friend drogon::orm::BaseBuilder<Access, false, true>;
    friend drogon::orm::BaseBuilder<Access, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Access>;
#endif
    ...
    std::shared_ptr<int32_t> devicesId_;
