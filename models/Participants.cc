...
const std::string Participants::primaryKeyName = "id";
...
const int32_t &Participants::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t> &Participants::getId() const noexcept
{
    return id_;
}
void Participants::setId(const int32_t &pId) noexcept
{
    id_ = std::make_shared<int32_t>(pId);
    dirtyFlag_[0] = true;
}
const typename Participants::PrimaryKeyType & Participants::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}

const int32_t &Participants::getValueOfConversationId() const noexcept
{
    static const int32_t defaultValue = int32_t();
    if(conversationId_)
...
const std::shared_ptr<int32_t> &Participants::getConversationId() const noexcept
{
    return conversationId_;
}
void Participants::setConversationId(const int32_t &pConversationId) noexcept
{
...
const std::string &Participants::getValueOfType() const noexcept
{
...
const std::shared_ptr<std::string> &Participants::getType() const noexcept
{
    return type_;
}
void Participants::setType(const std::string &pType) noexcept
{
    type_ = std::make_shared<std::string>(pType);
    dirtyFlag_[3] = true;
}
void Participants::setType(std::string &&pType) noexcept
{
    type_ = std::make_shared<std::string>(std::move(pType));
    dirtyFlag_[3] = true;
}

const ::trantor::Date &Participants::getValueOfCreatedAt() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &Participants::getCreatedAt() const noexcept
{
    return createdAt_;
}
void Participants::setCreatedAt(const ::trantor::Date &pCreatedAt) noexcept
{
    createdAt_ = std::make_shared<::trantor::Date>(pCreatedAt);
    dirtyFlag_[4] = true;
}

const ::trantor::Date &Participants::getValueOfUpdatedAt() const noexcept
{
    static const ::trantor::Date defaultValue = ::trantor::Date();
    if(updatedAt_)
        return *updatedAt_;
...
const std::shared_ptr<::trantor::Date> &Participants::getUpdatedAt() const noexcept
{
    return updatedAt_;
}
void Participants::setUpdatedAt(const ::trantor::Date &pUpdatedAt) noexcept
{
