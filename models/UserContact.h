...
class UserContact
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//user_id,contact_id
     ...
     */
    explicit UserContact(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserContact(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserContact(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const int32_t &getValueOfContactId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getContactId() const noexcept;
    ///Set the value of the column contact_id
    void setContactId(const int32_t &pContactId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UserContact>;
    friend drogon::orm::BaseBuilder<UserContact, true, true>;
    friend drogon::orm::BaseBuilder<UserContact, true, false>;
    friend drogon::orm::BaseBuilder<UserContact, false, true>;
    friend drogon::orm::BaseBuilder<UserContact, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserContact>;
#endif
    ...
    std::shared_ptr<int32_t> contactId_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = ? and contact_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = ? and contact_id = ?";
        return sql;
    }
