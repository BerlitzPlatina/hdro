...
class BlockList
{
  public:
     ...
     */
    explicit BlockList(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit BlockList(const Json::Value &pJson) noexcept(false);
     ...
     */
    BlockList(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<BlockList>;
    friend drogon::orm::BaseBuilder<BlockList, true, true>;
    friend drogon::orm::BaseBuilder<BlockList, true, false>;
    friend drogon::orm::BaseBuilder<BlockList, false, true>;
    friend drogon::orm::BaseBuilder<BlockList, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<BlockList>;
#endif
