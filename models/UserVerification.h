...
class UserVerification
{
  public:
     ...
     */
    explicit UserVerification(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserVerification(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserVerification(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const std::string &getValueOfVerificationCode() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getVerificationCode() const noexcept;
    ///Set the value of the column verification_code
    void setVerificationCode(const std::string &pVerificationCode) noexcept;
    void setVerificationCode(std::string &&pVerificationCode) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UserVerification>;
    friend drogon::orm::BaseBuilder<UserVerification, true, true>;
    friend drogon::orm::BaseBuilder<UserVerification, true, false>;
    friend drogon::orm::BaseBuilder<UserVerification, false, true>;
    friend drogon::orm::BaseBuilder<UserVerification, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserVerification>;
#endif
