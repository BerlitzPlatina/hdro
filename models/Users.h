...
class Users
{
  public:
    struct Cols
    {
        ...
        static const std::string _is_reported;
        static const std::string _is_blocked;
        static const std::string _preferences;
    ...
    /**  For column is_reported  */
    ///Get the value of the column is_reported, returns the default value if the column is null
    const int8_t &getValueOfIsReported() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int8_t> &getIsReported() const noexcept;
    ///Set the value of the column is_reported
    void setIsReported(const int8_t &pIsReported) noexcept;
    ...
    ///Get the value of the column preferences, returns the default value if the column is null
    const std::string &getValueOfPreferences() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPreferences() const noexcept;
    ///Set the value of the column preferences
    void setPreferences(const std::string &pPreferences) noexcept;
    void setPreferences(std::string &&pPreferences) noexcept;
    void setPreferencesToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<int8_t> isReported_;
    std::shared_ptr<int8_t> isBlocked_;
    std::shared_ptr<std::string> preferences_;
